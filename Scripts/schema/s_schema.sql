...
begin
  ...
  if not found then
    ...
    response.id := null;
    response.updated := null;
    response.message := 'Error: Schema not Found for Primary Key: ' || coalesce(in_id::text, 'NULL');
...
begin
  ...
  if not found then
    ...
    response.id := null;
    response.updated := null;
    response.message := 'Error: Schema does not exist for Primary Key: ' || coalesce(in_id::text, 'NULL');
...
begin
  ...
  if not found then
    ...
    response.id := null;
    response.updated := null;
    response.message := 'Error: Schema does not exist for id: ' || coalesce(in_id::text, 'NULL');
