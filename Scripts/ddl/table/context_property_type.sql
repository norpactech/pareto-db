...
CREATE UNIQUE INDEX context_property_type_alt_key
    ON pareto.context_property_type(id_tenant, id_context, id_generic_property_type);

ALTER TABLE pareto.context_property_type
  ADD CONSTRAINT context_property_type_id_tenant
...
ALTER TABLE pareto.context_property_type ENABLE ROW LEVEL SECURITY;
CREATE POLICY tenant_isolation_policy ON pareto.context_property_type
