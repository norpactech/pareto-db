-- -------------------------------------------------------
-- Deactivate data_object (Soft Delete)
-- ------------------------------------------------------
CREATE OR REPLACE FUNCTION pareto.deact_data_object(
  IN id UUID,
...
DECLARE
  ...
  c_service_name TEXT := 'deact_data_object';
...
BEGIN
  ...
  -- ------------------------------------------------------
  -- Deactivate data_object
  -- ------------------------------------------------------

  UPDATE pareto.data_object
     SET is_active = FALSE
   WHERE data_object.id = v_id
     AND data_object.updated_at = v_updated_at
  RETURNING data_object.id, data_object.updated_at INTO v_id, v_updated_at;
...
-- -------------------------------------------------------
-- Reactivate data_object (Soft Undelete)
-- ------------------------------------------------------
CREATE OR REPLACE FUNCTION pareto.react_data_object(
  IN id UUID,
  IN updated_at TIMESTAMPTZ,
  IN updated_by TEXT
)
...
DECLARE
  ...
  c_service_name TEXT := 'react_data_object';
