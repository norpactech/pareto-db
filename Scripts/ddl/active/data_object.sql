...
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS pareto.deact_data_object;
CREATE FUNCTION pareto.deact_data_object (
  IN p_id UUID, 
...
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS pareto.react_data_object;
CREATE FUNCTION pareto.react_data_object (
  IN p_id UUID, 
  IN p_updated_at TIMESTAMP, 
  IN p_updated_by VARCHAR
)
