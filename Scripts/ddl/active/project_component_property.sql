-- -------------------------------------------------------
-- Deactivate project_component_property (Soft Delete)
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS pareto.deact_project_component_property;
CREATE FUNCTION pareto.deact_project_component_property (
  IN p_id UUID, 
...
DECLARE
  ...
  c_service_name TEXT := 'deact_project_component_property';
...
BEGIN
  ...
  -- ------------------------------------------------------
  -- Deactivate project_component_property
  -- ------------------------------------------------------

 UPDATE pareto.project_component_property
    SET is_active = false 
    WHERE id = v_id
...
-- -------------------------------------------------------
-- Reactivate project_component_property (Soft Undelete)
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS pareto.react_project_component_property;
CREATE FUNCTION pareto.react_project_component_property (
  IN p_id UUID, 
  IN p_updated_at TIMESTAMP, 
  IN p_updated_by VARCHAR
)
...
DECLARE
  ...
  c_service_name TEXT := 'react_project_component_property';
