...
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS pareto.deact_ref_tables;
CREATE FUNCTION pareto.deact_ref_tables (
  IN p_id UUID, 
...
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS pareto.react_ref_tables;
CREATE FUNCTION pareto.react_ref_tables (
  IN p_id UUID, 
  IN p_updated_at TIMESTAMP, 
  IN p_updated_by VARCHAR
)
