...
-- ------------------------------------------------------
CREATE OR REPLACE FUNCTION pareto.deact_project(
  IN id UUID,
...
BEGIN
  ...
  UPDATE pareto.project
   ...
   WHERE project.id = v_id
     AND project.updated_at = v_updated_at
  RETURNING project.id, project.updated_at INTO v_id, v_updated_at;
...
-- ------------------------------------------------------
CREATE OR REPLACE FUNCTION pareto.react_project(
  IN id UUID,
  IN updated_at TIMESTAMPTZ,
  IN updated_by TEXT
)
