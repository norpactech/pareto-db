...
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS pareto.deact_cardinality;
CREATE FUNCTION pareto.deact_cardinality (
  IN p_id UUID, 
...
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS pareto.react_cardinality;
CREATE FUNCTION pareto.react_cardinality (
  IN p_id UUID, 
  IN p_updated_at TIMESTAMP, 
  IN p_updated_by VARCHAR
)
