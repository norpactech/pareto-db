-- -------------------------------------------------------
-- Deactivate cardinality (Soft Delete)
-- ------------------------------------------------------
CREATE OR REPLACE FUNCTION pareto.deact_cardinality(
  IN id UUID,
...
DECLARE
  ...
  c_service_name TEXT := 'deact_cardinality';
...
BEGIN
  ...
  -- ------------------------------------------------------
  -- Deactivate cardinality
  -- ------------------------------------------------------

  UPDATE pareto.cardinality
     SET is_active = FALSE
   WHERE cardinality.id = v_id
     AND cardinality.updated_at = v_updated_at
...
-- -------------------------------------------------------
-- Reactivate cardinality (Soft Undelete)
-- ------------------------------------------------------
CREATE OR REPLACE FUNCTION pareto.react_cardinality(
  IN id UUID,
  IN updated_at TIMESTAMPTZ,
  IN updated_by TEXT
)
...
DECLARE
  ...
  c_service_name TEXT := 'react_cardinality';
