...
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS pareto.deact_property;
CREATE FUNCTION pareto.deact_property (
  IN p_id UUID, 
...
DECLARE
  ...
  c_service_name TEXT := 'deact_property';
...
-- -------------------------------------------------------
-- Reactivate property (Soft Undelete)
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS pareto.react_property;
CREATE FUNCTION pareto.react_property (
  IN p_id UUID, 
  IN p_updated_at TIMESTAMP, 
  IN p_updated_by VARCHAR
)
...
DECLARE
  ...
  c_service_name TEXT := 'react_property';
