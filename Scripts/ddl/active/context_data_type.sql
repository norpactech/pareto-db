...
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS pareto.deact_context_data_type;
CREATE FUNCTION pareto.deact_context_data_type (
  IN p_id UUID, 
...
BEGIN
  ...
  -- ------------------------------------------------------
  -- Deactivate context_data_type
  -- ------------------------------------------------------

 UPDATE pareto.context_data_type
    SET is_active = false 
    WHERE id = v_id
...
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS pareto.react_context_data_type;
CREATE FUNCTION pareto.react_context_data_type (
  IN p_id UUID, 
  IN p_updated_at TIMESTAMP, 
  IN p_updated_by VARCHAR
)
