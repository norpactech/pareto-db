...
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS pareto.deact_index_property;
CREATE FUNCTION pareto.deact_index_property (
  IN p_id UUID, 
...
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS pareto.react_index_property;
CREATE FUNCTION pareto.react_index_property (
  IN p_id UUID, 
  IN p_updated_at TIMESTAMP, 
  IN p_updated_by VARCHAR
)
