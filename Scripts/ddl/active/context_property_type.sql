-- -------------------------------------------------------
-- Deactivate context_property_type (Soft Delete)
-- ------------------------------------------------------
CREATE OR REPLACE FUNCTION pareto.deact_context_property_type(
  IN id UUID,
...
DECLARE
  ...
  c_service_name TEXT := 'deact_context_property_type';
...
BEGIN
  ...
  -- ------------------------------------------------------
  -- Deactivate context_property_type
  -- ------------------------------------------------------

  UPDATE pareto.context_property_type
     SET is_active = FALSE
   WHERE context_property_type.id = v_id
     AND context_property_type.updated_at = v_updated_at
  RETURNING context_property_type.id, context_property_type.updated_at INTO v_id, v_updated_at;
...
-- -------------------------------------------------------
-- Reactivate context_property_type (Soft Undelete)
-- ------------------------------------------------------
CREATE OR REPLACE FUNCTION pareto.react_context_property_type(
  IN id UUID,
  IN updated_at TIMESTAMPTZ,
  IN updated_by TEXT
)
...
DECLARE
  ...
  c_service_name TEXT := 'react_context_property_type';
...
BEGIN
  ...
  -- ------------------------------------------------------
  -- Reactivate context_property_type
  -- ------------------------------------------------------
