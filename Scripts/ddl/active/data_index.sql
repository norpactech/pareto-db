-- -------------------------------------------------------
-- Deactivate data_index (Soft Delete)
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS pareto.deact_data_index;
CREATE FUNCTION pareto.deact_data_index (
  IN p_id UUID, 
...
DECLARE
  ...
  c_service_name TEXT := 'deact_data_index';
...
BEGIN
  ...
  -- ------------------------------------------------------
  -- Deactivate data_index
  -- ------------------------------------------------------

 UPDATE pareto.data_index
    SET is_active = false 
    WHERE id = v_id
...
-- -------------------------------------------------------
-- Reactivate data_index (Soft Undelete)
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS pareto.react_data_index;
CREATE FUNCTION pareto.react_data_index (
  IN p_id UUID, 
  IN p_updated_at TIMESTAMP, 
  IN p_updated_by VARCHAR
)
...
DECLARE
  ...
  c_service_name TEXT := 'react_data_index';
