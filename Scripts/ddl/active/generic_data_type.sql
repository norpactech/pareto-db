...
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS pareto.deact_generic_data_type;
CREATE FUNCTION pareto.deact_generic_data_type (
  IN p_id UUID, 
...
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS pareto.react_generic_data_type;
CREATE FUNCTION pareto.react_generic_data_type (
  IN p_id UUID, 
  IN p_updated_at TIMESTAMP, 
  IN p_updated_by VARCHAR
)
