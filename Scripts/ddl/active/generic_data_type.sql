-- -------------------------------------------------------
-- Deactivate generic_data_type (Soft Delete)
-- ------------------------------------------------------
CREATE OR REPLACE FUNCTION pareto.deact_generic_data_type(
  IN id UUID,
...
DECLARE
  ...
  c_service_name TEXT := 'deact_generic_data_type';
...
BEGIN
  ...
  -- ------------------------------------------------------
  -- Deactivate generic_data_type
  -- ------------------------------------------------------

  UPDATE pareto.generic_data_type
     SET is_active = FALSE
   WHERE generic_data_type.id = v_id
     AND generic_data_type.updated_at = v_updated_at
  RETURNING generic_data_type.id, generic_data_type.updated_at INTO v_id, v_updated_at;
...
-- -------------------------------------------------------
-- Reactivate generic_data_type (Soft Undelete)
-- ------------------------------------------------------
CREATE OR REPLACE FUNCTION pareto.react_generic_data_type(
  IN id UUID,
  IN updated_at TIMESTAMPTZ,
  IN updated_by TEXT
)
...
DECLARE
  ...
  c_service_name TEXT := 'react_generic_data_type';
