...
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS pareto.deact_schema;
CREATE FUNCTION pareto.deact_schema (
  IN p_id UUID, 
...
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS pareto.react_schema;
CREATE FUNCTION pareto.react_schema (
  IN p_id UUID, 
  IN p_updated_at TIMESTAMP, 
  IN p_updated_by VARCHAR
)
