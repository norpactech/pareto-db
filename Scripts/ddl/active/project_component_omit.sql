-- -------------------------------------------------------
-- Deactivate project_component_omit (Soft Delete)
-- ------------------------------------------------------
CREATE OR REPLACE FUNCTION pareto.deact_project_component_omit(
  IN id UUID,
...
DECLARE
  ...
  c_service_name TEXT := 'deact_project_component_omit';
...
BEGIN
  ...
  -- ------------------------------------------------------
  -- Deactivate project_component_omit
  -- ------------------------------------------------------
...
-- -------------------------------------------------------
-- Reactivate project_component_omit (Soft Undelete)
-- ------------------------------------------------------
CREATE OR REPLACE FUNCTION pareto.react_project_component_omit(
  IN id UUID,
  IN updated_at TIMESTAMPTZ,
  IN updated_by TEXT
)
...
DECLARE
  ...
  c_service_name TEXT := 'react_project_component_omit';
...
BEGIN
  ...
  -- ------------------------------------------------------
  -- Reactivate project_component_omit
  -- ------------------------------------------------------
