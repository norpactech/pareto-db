-- -------------------------------------------------------
-- Deactivate project_component_data_object (Soft Delete)
-- ------------------------------------------------------
CREATE OR REPLACE FUNCTION pareto.deact_project_component_data_object(
  IN id UUID,
...
DECLARE
  ...
  c_service_name TEXT := 'deact_project_component_data_object';
...
BEGIN
  ...
  -- ------------------------------------------------------
  -- Deactivate project_component_data_object
  -- ------------------------------------------------------

  UPDATE pareto.project_component_data_object
     SET is_active = FALSE
   WHERE project_component_data_object.id = v_id
     AND project_component_data_object.updated_at = v_updated_at
  RETURNING project_component_data_object.id, project_component_data_object.updated_at INTO v_id, v_updated_at;
...
-- -------------------------------------------------------
-- Reactivate project_component_data_object (Soft Undelete)
-- ------------------------------------------------------
CREATE OR REPLACE FUNCTION pareto.react_project_component_data_object(
  IN id UUID,
  IN updated_at TIMESTAMPTZ,
  IN updated_by TEXT
)
...
DECLARE
  ...
  c_service_name TEXT := 'react_project_component_data_object';
...
BEGIN
  ...
  -- ------------------------------------------------------
  -- Reactivate project_component_data_object
  -- ------------------------------------------------------
