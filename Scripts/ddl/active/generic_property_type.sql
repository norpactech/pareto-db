-- -------------------------------------------------------
-- Deactivate generic_property_type (Soft Delete)
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS pareto.deact_generic_property_type;
CREATE FUNCTION pareto.deact_generic_property_type (
  IN p_id UUID, 
...
BEGIN
  ...
  -- ------------------------------------------------------
  -- Deactivate generic_property_type
  -- ------------------------------------------------------

 UPDATE pareto.generic_property_type
    SET is_active = false 
    WHERE id = v_id
...
-- -------------------------------------------------------
-- Reactivate generic_property_type (Soft Undelete)
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS pareto.react_generic_property_type;
CREATE FUNCTION pareto.react_generic_property_type (
  IN p_id UUID, 
  IN p_updated_at TIMESTAMP, 
  IN p_updated_by VARCHAR
)
...
DECLARE
  ...
  c_service_name TEXT := 'react_generic_property_type';
