-- -------------------------------------------------------
-- Deactivate project_component (Soft Delete)
-- ------------------------------------------------------
CREATE OR REPLACE FUNCTION pareto.deact_project_component(
  IN id UUID,
...
BEGIN
  ...
  -- ------------------------------------------------------
  -- Deactivate project_component
  -- ------------------------------------------------------

  UPDATE pareto.project_component
     SET is_active = FALSE
   WHERE project_component.id = v_id
     AND project_component.updated_at = v_updated_at
  RETURNING project_component.id, project_component.updated_at INTO v_id, v_updated_at;
...
-- -------------------------------------------------------
-- Reactivate project_component (Soft Undelete)
-- ------------------------------------------------------
CREATE OR REPLACE FUNCTION pareto.react_project_component(
  IN id UUID,
  IN updated_at TIMESTAMPTZ,
  IN updated_by TEXT
)
...
DECLARE
  ...
  c_service_name TEXT := 'react_project_component';
