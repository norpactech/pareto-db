...
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS pareto.deact_project_component;
CREATE FUNCTION pareto.deact_project_component (
  IN p_id UUID, 
...
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS pareto.react_project_component;
CREATE FUNCTION pareto.react_project_component (
  IN p_id UUID, 
  IN p_updated_at TIMESTAMP, 
  IN p_updated_by VARCHAR
)
