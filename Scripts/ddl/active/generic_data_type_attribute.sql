...
-- ------------------------------------------------------
CREATE OR REPLACE FUNCTION pareto.deact_generic_data_type_attribute(
  IN id UUID,
...
BEGIN
  ...
  UPDATE pareto.generic_data_type_attribute
     SET is_active = FALSE
   WHERE generic_data_type_attribute.id = v_id
     AND generic_data_type_attribute.updated_at = v_updated_at
  RETURNING generic_data_type_attribute.id, generic_data_type_attribute.updated_at INTO v_id, v_updated_at;
...
-- ------------------------------------------------------
CREATE OR REPLACE FUNCTION pareto.react_generic_data_type_attribute(
  IN id UUID,
  IN updated_at TIMESTAMPTZ,
  IN updated_by TEXT
)
...
BEGIN
  ...
  -- ------------------------------------------------------
  -- Reactivate generic_data_type_attribute
  -- ------------------------------------------------------
