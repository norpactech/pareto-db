...
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS pareto.deact_ref_table_type;
CREATE FUNCTION pareto.deact_ref_table_type (
  IN p_id UUID, 
...
DECLARE
  ...
  c_service_name TEXT := 'deact_ref_table_type';
...
BEGIN
  ...
  -- ------------------------------------------------------
  -- Deactivate ref_table_type
  -- ------------------------------------------------------

 UPDATE pareto.ref_table_type
    SET is_active = false 
    WHERE id = v_id
...
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS pareto.react_ref_table_type;
CREATE FUNCTION pareto.react_ref_table_type (
  IN p_id UUID, 
  IN p_updated_at TIMESTAMP, 
  IN p_updated_by VARCHAR
)
...
DECLARE
  ...
  c_service_name TEXT := 'react_ref_table_type';
