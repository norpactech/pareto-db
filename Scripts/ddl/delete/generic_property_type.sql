-- -------------------------------------------------------
-- Delete generic_property_type
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS pareto.d_generic_property_type;
CREATE FUNCTION pareto.d_generic_property_type(
  IN p_id UUID, 
...
DECLARE
  ...
  c_service_name TEXT := 'd_generic_property_type';
