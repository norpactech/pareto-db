-- -------------------------------------------------------
-- Delete data_index_property
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS pareto.d_data_index_property;
CREATE FUNCTION pareto.d_data_index_property(
  IN p_id UUID, 
...
DECLARE
  ...
  c_service_name TEXT := 'd_data_index_property';
...
BEGIN
  ...
  DELETE FROM pareto.data_index_property 
    WHERE id = v_id
