-- -------------------------------------------------------
-- Delete project_component_property
-- ------------------------------------------------------
DROP FUNCTION IF EXISTS pareto.d_project_component_property;
CREATE FUNCTION pareto.d_project_component_property(
  IN p_id UUID, 
...
DECLARE
  ...
  c_service_name TEXT := 'd_project_component_property';
...
BEGIN
  ...
  DELETE FROM pareto.project_component_property 
    WHERE id = v_id
