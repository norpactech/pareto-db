-- -------------------------------------------------------
-- Delete generic_data_type
-- ------------------------------------------------------
CREATE OR REPLACE FUNCTION pareto.d_generic_data_type(
  IN id UUID,
...
DECLARE
  ...
  c_service_name TEXT := 'd_generic_data_type';
...
BEGIN
  ...
  DELETE FROM pareto.generic_data_type 
