-- ---------------------------------------------------------------------------------------
-- Insert: pareto.context_data_type. Generated by Pareto Factory™ "Be Consistent"
-- ---------------------------------------------------------------------------------------
CREATE OR REPLACE FUNCTION pareto.i_context_data_type(
  IN id uuid, 
  IN id_context uuid, 
...
DECLARE
  ...
  c_service_name TEXT := 'i_context_data_type';
