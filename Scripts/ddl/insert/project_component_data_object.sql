-- ---------------------------------------------------------------------------------------
-- Insert: pareto.project_component_data_object. Generated by Pareto Factory™ "Be Consistent"
-- ---------------------------------------------------------------------------------------
CREATE OR REPLACE FUNCTION pareto.i_project_component_data_object(
...
DECLARE
  ...
  c_service_name TEXT := 'i_project_component_data_object';
...
BEGIN
  ...
  INSERT INTO pareto.project_component_data_object (
  ...
  EXCEPTION
    WHEN UNIQUE_VIOLATION THEN
      v_response := (
        ...
        'A record already exists in the project_component_data_object table', 
