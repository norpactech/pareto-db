-- ---------------------------------------------------------------------------------------
-- Insert: pareto.data_object. Generated by Pareto Factory™ "Be Consistent"
-- ---------------------------------------------------------------------------------------
CREATE OR REPLACE FUNCTION pareto.i_data_object(
  IN id uuid, 
  IN id_schema uuid, 
  IN name varchar, 
  IN description text, 
...
DECLARE
  ...
  c_service_name TEXT := 'i_data_object';
  ...
  EXCEPTION
    WHEN UNIQUE_VIOLATION THEN
      v_response := (
        ...
        'A record already exists in the data_object table', 
