-- -------------------------------------------------------
-- Update generic_data_type_attribute
--
-- Supports Optimistic Locking using Updated At
-- ------------------------------------------------------
CREATE OR REPLACE FUNCTION pareto.u_generic_data_type_attribute(
  IN id uuid, 
...
DECLARE
  ...
  c_service_name TEXT := 'u_generic_data_type_attribute';
...
BEGIN
  ...
  UPDATE pareto.generic_data_type_attribute SET
    id_generic_data_type = v_id_generic_data_type, 
    id_rt_attr_data_type = v_id_rt_attr_data_type, 
    name = v_name, 
