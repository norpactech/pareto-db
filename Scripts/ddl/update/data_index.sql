-- ---------------------------------------------------------------------------------------
-- Update: pareto.data_index. Generated by Pareto Factory™ "Be Consistent"
-- ---------------------------------------------------------------------------------------
DROP FUNCTION IF EXISTS pareto.u_data_index;
CREATE FUNCTION pareto.u_data_index(
  IN p_id UUID, 
...
DECLARE
  ...
  c_service_name TEXT := 'u_data_index';
