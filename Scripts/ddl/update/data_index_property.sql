-- ---------------------------------------------------------------------------------------
-- Update: pareto.data_index_property. Generated by Pareto Factory™ "Be Consistent"
-- ---------------------------------------------------------------------------------------
DROP FUNCTION IF EXISTS pareto.u_data_index_property;
CREATE FUNCTION pareto.u_data_index_property(
  IN p_id UUID, 
...
DECLARE
  ...
  c_service_name TEXT := 'u_data_index_property';
...
BEGIN
  ...
  UPDATE pareto.data_index_property SET
    id_property = p_id_property, 
    id_rt_sort_order = p_id_rt_sort_order, 
    sequence = p_sequence, 
    updated_by = p_updated_by, 
