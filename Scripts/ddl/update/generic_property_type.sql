-- -------------------------------------------------------
-- Update generic_property_type
--
-- Supports Optimistic Locking using Updated At
-- ------------------------------------------------------
CREATE OR REPLACE FUNCTION pareto.u_generic_property_type(
  IN id uuid, 
...
DECLARE
  ...
  c_service_name TEXT := 'u_generic_property_type';
...
BEGIN
  ...
  UPDATE pareto.generic_property_type SET
